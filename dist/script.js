...
var forms = function forms() {
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_6__["checkNumInputs"])('input[name="phone"]');
  Object(_services_services__WEBPACK_IMPORTED_MODULE_6__["checkTextInputs"])('[name="name"]');
  Object(_services_services__WEBPACK_IMPORTED_MODULE_6__["checkTextInputs"])('[name="message"]');
  var message = {
    // Объект со статусами
    loading: 'Загрузка...',
  ...
  form.forEach(function (item) {
    ...
    item.addEventListener('submit', function (event) {
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_7__["postData"])(api, formData).then(function (res) {
        ...
        Object(_services_services__WEBPACK_IMPORTED_MODULE_6__["clearInputs"])();
        setTimeout(function () {
