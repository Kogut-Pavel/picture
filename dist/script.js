...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_5__["default"])('#size', '#material', '#option', '.promocode', '.calc-price', '[data-calc]', formState);
...
var calc = function calc(size, material, option, promocode, result, trigger, state) {
  ...
  var calc = document.querySelectorAll('.calc select');
  var sum = 0;
  btn.disabled = true;
...
var filter = function filter() {
  ...
  menu.addEventListener('click', function (e) {
    ...
    var allElems = wrapper.querySelectorAll(".".concat(target.classList[0]));
    typeFilter(allElems);
  });
};
...
var forms = function forms(state) {
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_13__["checkNumInputs"])('input[name="phone"]');
  Object(_services_services__WEBPACK_IMPORTED_MODULE_13__["checkTextInputs"])('[name="name"]');
  Object(_services_services__WEBPACK_IMPORTED_MODULE_13__["checkTextInputs"])('[name="message"]');
  var message = {
    // Объект со статусами
    loading: 'Загрузка...',
  ...
  var path = {
    // Пути серверов для дизайнера и просто консультации
  ...
  form.forEach(function (item) {
    ...
    item.addEventListener('submit', function (event) {
      ...
      item.closest('.popup-design') || item.classList.contains('calc-form') ? api = path.designer : api = path.question; // Отправляем запрос на сервер с данными из formData
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_14__["postData"])(api, formData).then(function (res) {
        ...
        Object(_services_services__WEBPACK_IMPORTED_MODULE_13__["clearInputs"])();
        setTimeout(function () {
          statusMessage.remove();
          item.style.display = 'block';
          item.classList.remove('fadeOutUp');
          item.classList.add('fadeInUp');
          Object(_services_services__WEBPACK_IMPORTED_MODULE_13__["clearState"])(state);
...
var showMoreStyles = function showMoreStyles(wrapper, trigger) {
  var btn = document.querySelector(trigger);
  btn.addEventListener('click', function () {
...
var sliders = function sliders(slides, dir, prev, next) {
  ...
  } catch (error) {} // Анимация автоматического переключения слайдов
  ...
  activateAnimation(); // Убираем автоматическое переключение слайдов при наведении курсором на слайдер

  items[0].parentNode.addEventListener('mouseenter', function () {
    clearInterval(paused);
  }); // Возвращаем автоматическое переключение слайдов при убирании курсора от слайдера
...
/*!*************************************!*\
  !*** ./src/js/services/services.js ***!
  \*************************************/
/*! exports provided: calcScroll, modifyBody, checkNumInputs, checkTextInputs, clearInputs, closeModals, clearState */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var clearInputs = function clearInputs() {
  ...
  var upload = document.querySelectorAll('[name="upload"]'); // Инпуты с загрузкой изображения
